...
/// @title JuniorPool
/// @notice ERC-4626 vault representing the junior first-loss liquidity tranche.
/// @dev
/// JuniorPool tracks pool-accounted NAV separately from raw token balance.
...
contract JuniorPool is ERC4626 {
